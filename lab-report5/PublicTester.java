...
public class PublicTester {
    ...
    @Test
    public void testMinHeapGetMinChildIdxNoKids(){
        MyMinHeap<Integer> heap = initMinHeap(Arrays.asList(5, 3, 2));
        heap.getMinChildIdx(2);
        assertEquals("Should return -1", -1, heap.getMinChildIdx(2));
        assertEquals("Should return -1", -1, heap.getMinChildIdx(1));
    }
    ...
    public void testLastAtom() {
        ArrayList<Integer> atoms = 
                new ArrayList<>(Arrays.asList(2, 5, 3, 2));
